        ...
        <div className="bg-white block py-10">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="w-full">
                    <div className="w-full bg-green-600 h-48 rounded-t-lg"> {/* Dark green boarder */}
                    </div>
                ...
                <div> {/* contains user info */}
                    <div className="bg-primary border border-primary rounded-b-lg p-5 pt-20 flex flex-col">
                        <h5 className="mb-1 bg-green-100 h-5 w-auto h-10 text-justify text-4xl">{camper.username}</h5>
                    </div>
