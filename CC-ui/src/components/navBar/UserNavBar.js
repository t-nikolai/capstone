    ...
    return (
        <div>
            <nav className="flex items-center justify-between flex-wrap bg-green-700 px-4 pt-3">
                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow visibility:hidden lg:visable">
                        ...
                        <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-green-300 hover:text-white mr-4 "> make a reservation </a>
                    </div>
                    <div>
            ...
            <div className="flex items-center flex-wrap text-green-100 bg-green-700 p-1">
                <img className="fill-current mr-2 w-8 h-8 p-1" src="images/loginIcon.png" alt="loginO=Icon" />
