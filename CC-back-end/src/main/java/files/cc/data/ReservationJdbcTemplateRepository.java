...
public class ReservationJdbcTemplateRepository implements ReservationRepository {
    ...
    public List<Reservation> findAll() throws DataAccessException {
        final String sql = "select r.reservation_id as reservation_id, r.start_date as start_date, r.end_date as end_date, r.total as total, " +
                ...
                "cr.camper_id as camper_id, cr.username as username, cr.password as password, cr.role as role, cr.first_name as first_name, cr.last_name as last_name, cr.camping_method as camping_method, cr.phone as cr_phone, cr.email as cr_email, cr.address as cr_address, cr.city as cr_city, cr.`state` as cr_state, cr.zip as cr_zip " +
                "from reservation r " +
